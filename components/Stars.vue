...
<template>
    <div class="star-rating">
        <div class="flex absolute">
            <div v-for="star in 5" :key="star" class="star" @click="() => { console.log('-1'); setRating(star); }">
        ...
        <div class="flex">
            <div v-for="star in 5" :key="star" class="star relative" @click="() => { console.log('-1'); setRating(star); }">
